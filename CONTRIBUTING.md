# Contributing to FastAPI Redis Cache
...
3. If you've changed module, update the Readme.md.
...
## Report bugs using Github's [issues](https://github.com/santoshvandari/FastAPIRedisCache/issues)
...
- Steps to reproduce
  - Be specific!
  - Give sample queries if possible
